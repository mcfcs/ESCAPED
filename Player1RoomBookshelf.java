...
public class Player1RoomBookshelf extends Palette implements Popup{
    boolean isLooking = false;
    ArrayList<Button> buttons = new ArrayList<>();
    Button closeButton = new CloseButton();
    Player1RoomBookshelf(){
    ...
    public void draw(Graphics2D g2d) {
        if(!isLooking){
            ...
            g2d.setColor(popupBorder);
            g2d.setFont(f);
            g2d.drawString("There is something inside.", 128, 435);
            ...
            Image paper = new ImageIcon(this.getClass().getResource("/images/Player1RoomBookshelf.png")).getImage();
