...
public class MiddleHallwayPainting extends Palette implements Popup{
    ArrayList<Button> buttons = new ArrayList<>();
    Boolean isLooking = false;
    Button closeButton = new CloseButton();

    MiddleHallwayPainting(){
    ...
    public void draw(Graphics2D g2d) {
        if(!isLooking) {
            ...
            g2d.setColor(popupBorder);
            g2d.setFont(f);
            g2d.drawString("There is something behind the painting.", 128, 435);
            ...
            Image paintingBehind = new ImageIcon(this.getClass().getResource("/images/PaintingPopup.png")).getImage();
            g2d.drawImage(paintingBehind, 0, 0, null);
        }
    ...
    public ArrayList<Button> getButtons() {
        ...
        ArrayList<Button> close = new ArrayList<>();
